...
export const BUSINESS_TYPES: BusinessTypeDef[] = [
  ...
  { key: "hardware", label: "Hardware", icon: Wrench, tagline: "Units, bundles & supplier orders",
    ...
    imageUrl: "https://images.unsplash.com/photo-1586864387967-d02ef85d93e8?auto=format&fit=crop&q=80&w=600" },
  ...
  { key: "liquor", label: "Liquor Store", icon: Wine, tagline: "Age check & licensing",
    ...
    imageUrl: "https://images.unsplash.com/photo-1572196284554-4e321bf56553?auto=format&fit=crop&q=80&w=600" },
  ...
  { key: "mpesa", label: "Mobile Money Shop", icon: Smartphone, tagline: "Float tracking & commissions",
    ...
    imageUrl: "https://images.unsplash.com/photo-1620714223084-8fcacc6dfd8d?auto=format&fit=crop&q=80&w=600" },
