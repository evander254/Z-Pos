...
function Forgot() {
  ...
  return <AuthShell title="Reset password" subtitle="We'll send a reset link to your email.">
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <Button disabled={loading} className="w-full h-11 gradient-violet text-white border-0">{loading ? "Sending..." : "Send reset link"}</Button>
    </form>
